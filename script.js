...
portfolio.projects = [
	...
	{
		name: 'Pokemon Blackjack',
		desc: `A blackjack-style game where two players take turns controlling a Pokemon character. Fetches data from two REST APIs to display a dynamic game interface. Built with React as part of a development team following a client brief.`,
		liveurl: 'https://pokemon-blackjack-juno.netlify.app/',
		giturl: 'https://github.com/allisonvilla/pokemon-blackjack',
		img: './assets/poke-blackjack-preview.png',
		tools: [
			'js',
			'html',
			'css',
